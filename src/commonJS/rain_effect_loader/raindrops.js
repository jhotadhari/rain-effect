...
function Raindrops( inView, width, height , scale,dropAlpha,dropColor,options={}){
  ...
  updateRain(timeScale){
    ...
    if(this.options.raining){
      ...
      while(chance(this.options.rainChance*timeScale*this.areaMultiplier) && count<limit){
        count++;
        let r = random( this.options.minR, this.options.maxR, _interpolation );
